      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg text-white mb-8">
            Join us in our mission to provide free, inclusive academic support and culturally 
            responsive mentorship to underserved youth—especially immigrant, refugee, and 
            first-generation students—while fostering their overall well-being through safe, 
            empowering environments that promote belonging, resilience, and lifelong learning.
          </p>
        </div>
      </section>
